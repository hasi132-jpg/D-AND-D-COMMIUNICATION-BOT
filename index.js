...
async function connectToWA() {
  ...
  console.log("Connecting D&D BOT");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("D & D installed successful ✅");
      console.log("D & D connected to whatsapp ✅");

      let up = `D & D connected successful ✅`;
      let up1 = `Hello HASI, I made bot successful`;
      ...
      robin.sendMessage("94702382988@s.whatsapp.net", {
        image: {
          url: `https://raw.githubusercontent.com/hasi132-jpg/logo/refs/heads/main/d%20d%20commiunication1.jpg`,
        },
        caption: up1,
...
app.get("/", (req, res) => {
  res.send("hey, ❤️ D & D BOT ❤️ started✅");
});
app.listen(port, () =>
